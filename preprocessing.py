...
"""def BoW(m): #Renvoie X et Dico
    l = [ mot for k in m for mot in k]
    l = set(l)
    dico = dict(zip(l,range(len(l))))
...
print('Dico1')
print(len(dico))
print(mots_recurrents(X, dico, inverse_doc_frequency(X)))
print(len(mots_recurrents(X, dico, inverse_doc_frequency(X))))
X, dico = matriceX_Dico_processed_inverse(X, dico, inverse_doc_frequency(X))
print('Dico2')
print(len(dico))
"""
#print(len(dico))
